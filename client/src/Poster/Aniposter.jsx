...
import loadingimg from "../componets/images/luffyloading.gif"
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const res = await axios.get(`${BASE_URL}/api/v1/products?category=animiposter`);
    ...
    <br></br>
        <div className="containers">
           <div className="main-box">
            <h2 className="title-oversizes1">Anime Poster collections</h2>
            <br></br>
